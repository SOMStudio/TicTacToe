...
public class BaseMenuController : MonoBehaviour
{
	...
	protected string gamePrefsName = "DefaultGame";
	...
	[Header("Main window list")] [SerializeField]
	...
	[Header("DisActivate window")] [SerializeField]
	...
	[Header("Menu Data")] [SerializeField] protected bool menuActive = false;
	...
	[Header("Advice window")] [SerializeField]
	private AnimationOpenClose windowAdviceAnimation;

	[SerializeField] private Text windowAdviceText;

	[Header("Inform window")] [SerializeField]
	private AnimationOpenClose windowInformAnimation;

	[SerializeField] private Text[] windowInformTextList;

	[Header("Console windows")]
	[SerializeField] private Text consoleWInformSmallTextHead;
	[SerializeField] private Text consoleWInformSmallTextInfo;
	[SerializeField] private GameObject consoleWInformSmallPanelImage;
	[SerializeField] private Image consoleWInformSmallImage;
	...
	public void ConsoleWinInformationSmall_SetInf(string textHead, string textInformation, string pictureResors = "")
	{
		consoleWInformSmallTextHead.text = ConvertSpecTextChar(textHead);
		consoleWInformSmallTextInfo.text = ConvertSpecTextChar(textInformation);

		//scroll in up
		RectTransform rectTrans = consoleWInformSmallTextInfo.GetComponent<RectTransform>();
		...
		if (pictureResors == "")
		{
			consoleWInformSmallPanelImage.SetActive(false);
		}
		else
		{
			consoleWInformSmallPanelImage.SetActive(true);
			consoleWInformSmallImage.sprite = Resources.Load<Sprite>(pictureResors);
		}
	}
	...
	private string ConvertSpecTextChar(string st)
	{
		// text key
		if (HasSpecKeyText(st))
		{
